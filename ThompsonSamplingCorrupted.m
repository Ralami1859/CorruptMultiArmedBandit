...
function GlobalRegretTS = ThompsonSamplingCorrupted(BernoulliMeansMatrix, VectHorizon, alpha0, beta0, NbrIteration)
...
for iter = 1:NbrIteration;
    ...
    for n = 1:NbrPeriode;
        ...
        while(t <= VectHorizon(n))    
            ...
            reward = rand() < fct_corruption_dec(param_corr, bernoulliMeans(action));
